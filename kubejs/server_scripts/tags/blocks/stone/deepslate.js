ServerEvents.tags('item', event => {
	...
	event.add(global.id.KJ('block_types/deepslate'), global.id.CR('cut_deepslate'));
	event.add(global.id.KJ('block_types/deepslate'), global.id.CR('polished_cut_deepslate'));
	event.add(global.id.KJ('block_types/deepslate'), global.id.CR('cut_deepslate_bricks'));
	event.add(global.id.KJ('block_types/deepslate'), global.id.CR('small_deepslate_bricks'));
	event.add(global.id.KJ('block_types/deepslate'), global.id.CR('layered_deepslate'));
	event.add(global.id.KJ('block_types/deepslate'), global.id.CR('deepslate_pillar'));
	...
	event.add(global.id.KJ('slab_types/deepslate'), global.id.CR('cut_deepslate_slab'));
	event.add(global.id.KJ('slab_types/deepslate'), global.id.CR('polished_cut_deepslate_slab'));
	event.add(global.id.KJ('slab_types/deepslate'), global.id.CR('cut_deepslate_brick_slab'));
	event.add(global.id.KJ('slab_types/deepslate'), global.id.CR('small_deepslate_brick_slab'));
	...
	event.add(global.id.KJ('stair_types/deepslate'), global.id.CR('cut_deepslate_stairs'));
	event.add(global.id.KJ('stair_types/deepslate'), global.id.CR('polished_cut_deepslate_stairs'));
	event.add(global.id.KJ('stair_types/deepslate'), global.id.CR('cut_deepslate_brick_stairs'));
	event.add(global.id.KJ('stair_types/deepslate'), global.id.CR('small_deepslate_brick_stairs'));
	...
	event.add(global.id.KJ('wall_types/deepslate'), global.id.CR('cut_deepslate_wall'));
	event.add(global.id.KJ('wall_types/deepslate'), global.id.CR('polished_cut_deepslate_wall'));
	event.add(global.id.KJ('wall_types/deepslate'), global.id.CR('cut_deepslate_brick_wall'));
	event.add(global.id.KJ('wall_types/deepslate'), global.id.CR('small_deepslate_brick_wall'));
});