ServerEvents.tags('item', event => {
	...
	event.add(global.id.KJ('block_types/stone'), global.id.SP('stone_tile'));
	...
	event.add(global.id.KJ('slab_types/stone'), global.id.SP('stone_tile_slab'));
	...
	event.add(global.id.KJ('stair_types/stone'), global.id.SP('stone_tile_stairs'));
	...
	event.add(global.id.KJ('wall_types/stone'), global.id.SP('stone_tile_wall'));
});