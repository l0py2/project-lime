...
MinecraftStonecuttingRecipe.fromJson = (rawRecipe) => {
	if(rawRecipe.type != 'minecraft:stonecutting') {
		return null;
	}
		
	let recipe = new MinecraftStonecuttingRecipe();
...
function MinecraftStonecuttingRecipe() {
	this.modified = false;
	this.empty = false;
...
UnifyJS.recipeTypes.push(MinecraftStonecuttingRecipe);